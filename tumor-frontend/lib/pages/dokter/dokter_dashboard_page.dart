...
class DokterHomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final DokterController controller = Get.find<DokterController>(); // DIUBAH
    String todayDate =
...
class DokterDashboardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final DokterController controller = Get.put(DokterController()); // DIUBAH

    double screenWidth = MediaQuery.of(context).size.width;
    double screenHeight = MediaQuery.of(context).size.height;

    bool isMobile = screenWidth < 850;
    bool showDokterName = screenWidth > 1000;
    ...
    if (isMobile) {
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            const NotificationBell(role: 'Dokter'), // DIUBAH
            const SizedBox(width: 8),
